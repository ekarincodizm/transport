...
<table class="table table-bordered" style="width:100%; border-top: #000000 solid 1px;" cellpadding="1" cellspacing="0" width="100%">
    <tr>
    <tr style="font-weight: bold;">
        <td style="text-align:center;">ค่าจ้างขน<b> <?php echo number_format($model->price_affiliated, 2); ?></b> บาท</td>
    </tr>
</tr>
</table>
<!--
