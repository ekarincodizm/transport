...
<table class="table table-bordered" style="width: 100%;" cellpadding="1" cellspacing="0">
    <tr>
        <th colspan="4">
            ...
            <b>ลูกค้าต้นทาง : </b> <?php echo $customer_model->find()->where(['cus_id' => $assign->cus_start])->one()->company; ?><br/>
            <b>ลูกค้าปลายทาง : </b> <?php echo $customer_model->find()->where(['cus_id' => $assign->cus_end])->one()->company; ?>
        </th>
    </tr>
    ...
    <tr>
        ...
        <td style="text-align:center;">น้ำหนัก(ตัน)</td>
