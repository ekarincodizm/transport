    ...
    <body class="skin-blue-light fixed sidebar-collapse">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="#" class="logo" id="bg-sidebar" style=" background: #999999;">
                ...
                <nav class="navbar navbar-static-top" role="navigation" id="bg-nav-head">
            ...
            <div class="content-wrapper" id="<?php echo Yii::$app->session['themes']; ?>" style=" padding-bottom: 50px;">
            ...
            <footer class="navbar navbar-default navbar-fixed-bottom">
                <div class="container-fluid" style="padding-top: 10px; padding-left: 0px;">
                    <div class="row" style=" margin: 0px;">
                        <div class="col-sm-1 col-md-1 col-lg-1">
                            <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button" id="sidebar-toggle">
                                <div class="btn btn-default"><i class="fa fa-bars"></i></div>
                            </a>
                        </div>
