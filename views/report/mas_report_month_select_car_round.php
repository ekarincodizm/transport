...
$this->title = "บัญชีค่าใช้จ่ายของรถ คันที่ " . $car['car_id'] . " ทะเบียน (" . $car['truck_1'] . ") - (" . $car['truck_2'] . ") (ตามเที่ยววิ่ง)";
...
<script type="text/javascript">
    ...
    function load_report() {
        var url = "<?php echo Url::to(['report/load_report_month_select_car_round']) ?>";
        var year = $("#year").val();
        var month = $("#month").val();
