...
<div class="panel panel-primary">
    <div class=" panel-heading"><i class="fa fa-bar-chart-o"></i> กำไร - ขาดทุน(เดือน)</div>
    <?php echo $chart; ?>
    <div class="table table-responsive">
        <table class="table table-striped table-hover" id="report_year">
            <thead>
                <tr>
                    <th colspan="15">
                        <b style="color:#FFF;">สรุปยอด (กำไร - ขาดทุก) ปี พ.ศ. <?php echo ($year + 543) ?> เดือน <?php echo $monthFull[$month]; ?></b>
                    </th>
                </tr>
                <tr>
                    <th rowspan="2" valign="middle"><i class="fa fa-calendar"></i><br/>วันที่</th>
