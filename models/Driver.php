...
class Driver extends \yii\db\ActiveRecord {
    ...
    function history($driver_id = null) {
        $query = "SELECT a.id,a.transport_date,a.assign_id,a.cus_start,a.cus_end,a.changwat_start,a.changwat_end,
    ...
    function Conclude_incom_expenses($employee = null, $year = null, $month = null) {
        $query = "SELECT Q1.*
            FROM 
            (
            SELECT a.transport_date,CONCAT('เบี้ยเลี้ยงจากขนส่งในรายการ ',a.order_id,' รหัสสั่งงาน ',a.assign_id) AS detail,
