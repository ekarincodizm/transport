...
/**
 * OrdersTransportAffiliatedSearch represents the model behind the search form about `app\models\OrdersTransportAffiliated`.
 */
class OrdersTransportAffiliatedSearch extends OrdersTransportAffiliated
{
    /**
     * @inheritdoc
     */
    public function rules() {
        return [
            [['id', 'truck1', 'truck2', 'driver1', 'driver2','employer'], 'integer'],
